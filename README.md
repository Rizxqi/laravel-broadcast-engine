# 🔊 MOSEC — Music & Audio Streaming Control System

> A web-based public audio control system that lets operators manage music playlists and stream audio to multiple zones/devices over HTTP streaming. MOSEC integrates Laravel (backend + dashboard), Liquidsoap (audio mixer/engine), and Icecast (streaming server), all orchestrated via Docker.
...
*This documentation comprehensively covers the development of MOSEC — Music & Audio Streaming Control System.*
